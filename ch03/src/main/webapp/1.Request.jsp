...
<body>
	...
	<h4>GET 요청 방식</h4>
		<form action="./proc/result1.jsp" method="get">
			<input type="text" name="uid" placeholder="uid 입력"><br>
	...
	<form action="./proc/result3.jsp" method="post">
		<table border="1">
			...
			<tr>
				<td>생년월일</td>
				<td><input type="date" name="birth" placeholder="yyyy-mm-dd 입력"></td>
			</tr>
			<tr>
				<td>성별</td>
				<td>
